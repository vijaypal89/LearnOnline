...
class UserProfile(models.Model):
	...
	class Meta:
		db_table = u'learn_userprofile'

class UserFriend(models.Model):
	username = models.CharField(max_length=100)
	friends = models.ForeignKey(UserProfile)
	frienddate = models.DateTimeField(default=datetime.datetime.now())
	messages = models.ForeignKey('Message')
	class Meta:
		db_table = u'learn_userfriend'
...
class Message(models.Model):
	...
	class Meta:
		db_table = u'learn_message'

class Request(models.Model):
	username = models.CharField(max_length=100)
	allow = models.CharField(max_length=50)
	class Meta:
		db_table = u'learn_request'
